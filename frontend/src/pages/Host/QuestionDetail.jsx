...
const DetailQuestionPage = () => {
  ...
  return (
    <Box className="p-5">
      <Button variant="contained" className="me-3" startIcon={<Edit />}>
        Edit
      </Button>
      <Button
        variant="contained"
      ...
      <Card
        className="card-read-quiz text-dark shadow"
        sx={{ minHeight: "664px", maxHeight: "664px" }}
      >
        <CardContent>
          <Typography
            textAlign="center"
          ...
          <div className="d-flex flex-wrap justify-content-around">
            {[
              { text: option1, image: option1_image },
              { text: option2, image: option2_image },
              { text: option3, image: option3_image },
              { text: option4, image: option4_image },
            ].map((option, idx) => (
              <div
              ...
              >
                ...
                <CardMedia
                  ...
                  image={
                    option.image
                      ? `http://10.1.4.41/api/image/${option.image}`
                      : defaultImage
                  }
